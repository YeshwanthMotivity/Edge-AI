...
export default function Dashboard({ onNavigate }: DashboardProps) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="relative mb-16 overflow-hidden rounded-4xl bg-slate-50 dark:bg-gradient-to-br dark:from-brand-violet-600/20 dark:via-brand-obsidian dark:to-brand-obsidian border border-slate-200 dark:border-brand-violet-600/20 p-12 group transition-all">
                <div className="absolute top-0 right-0 w-96 h-96 bg-brand-violet-600/5 dark:bg-brand-violet-600/10 rounded-full blur-3xl -mr-48 -mt-48 animate-pulse"></div>
                <div className="relative z-10 max-w-2xl text-left">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-violet-600/10 border border-brand-violet-600/20 mb-6 transition-all group-hover:bg-brand-violet-600/20">
                    ...
                    <h2 className="text-5xl lg:text-6xl font-black text-slate-900 dark:text-white mb-6 leading-none tracking-tighter">
                        Welcome to <span className="text-brand-violet-600 dark:text-brand-violet-400 drop-shadow-[0_0_15px_rgba(107,70,255,0.4)]">EdgeAI Policy</span>
                    </h2>
                    <p className="text-xl text-slate-600 dark:text-slate-300 font-medium leading-relaxed opacity-90">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <div className="bg-white dark:glass-card-purple rounded-3xl p-8 border border-slate-200 dark:border-brand-violet-600/20 group hover:neon-border-purple transition-all duration-500 relative overflow-hidden shadow-sm hover:shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                ...
                <button
                    ...
                    className="group relative overflow-hidden rounded-4xl bg-white dark:bg-brand-obsidian-light/40 border border-slate-200 dark:border-white/5 p-10 text-left transition-all hover:bg-slate-50 dark:hover:bg-brand-obsidian-light/60"
                >
                    <div className="relative z-10">
                        <div className="mb-6 flex items-center justify-between">
            ...
            <div className="bg-slate-900 dark:bg-brand-obsidian-light/30 rounded-4xl shadow-2xl border border-white/5 p-12 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-96 h-96 bg-brand-violet-600/10 rounded-full -mr-48 -mt-48 blur-3xl transition-transform group-hover:scale-110 duration-1000"></div>
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-violet-600/10 rounded-full -ml-48 -mb-48 blur-3xl transition-transform group-hover:scale-110 duration-1000"></div>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
                    <div className="text-center md:text-left">
                        <div className="text-5xl font-black text-white mb-2 tracking-tighter drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                            {metrics.total_documents.toLocaleString()}
                        </div>
                        <div className="text-xs font-black text-brand-violet-400 uppercase tracking-[0.3em]">Total Documents</div>
                    </div>
                    <div className="text-center md:text-left">
                        <div className="text-5xl font-black text-white mb-2 tracking-tighter drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                            {metrics.total_redacted.toLocaleString()}
                        </div>
                        <div className="text-xs font-black text-brand-violet-400 uppercase tracking-[0.3em]">Redactions</div>
                    </div>
                    <div className="text-center md:text-left">
                        <div className="text-5xl font-black text-white mb-2 tracking-tighter drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                            {metrics.privacy_protected_percentage}%
                        </div>
                        <div className="text-xs font-black text-emerald-400 uppercase tracking-[0.3em]">Integrity</div>
                    </div>
                    <div className="text-center md:text-left">
                        <div className="text-5xl font-black text-white mb-2 tracking-tighter drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
                            {metrics.avg_processing_time}<span className="text-2xl opacity-50 ml-1">ms</span>
                        </div>
                        <div className="text-xs font-black text-slate-400 uppercase tracking-[0.3em]">Avg Latency</div>
                    </div>
                </div>
            </div>
